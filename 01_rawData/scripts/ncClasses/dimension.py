...
class dimension:
    ...
    def _copy(self):
        ...
        copied = dimension(self.ncFile, self.key, self.res)
        #print(copied.key)
        copied.res = deepcopy(self.res)
        copied.valsUncut = deepcopy(self.valsUncut)
        copied.vals = deepcopy(self.vals)
        #if copied.vals is not None:
        #    print(copied.vals.shape)
        ...
        copied.function = deepcopy(self.function)
