...
if nDPlot == 2:
    ...
    for res in an.resolutions:
        for mode in an.modes:
            vals = an.vars[fieldNames[0]].ncos[mode+res].field.vals
            #print(mode+res)
    ...
    for res in an.resolutions:
        for mode in an.modes:
            vals = an.vars[fieldNames[0]].ncos[mode+res].field.vals
            vals[:,0,0] =  values_masked[mode+res]
...
#an.vars[fieldNames[0]].ncos[mode+res].field.vals = \
#    np.nanmean(an.vars[fieldNames[0]].ncos[mode+res].field.vals, axis=1)
#an.vars[fieldNames[0]].ncos[mode+res].field.vals = \
#    np.nanmean(an.vars[fieldNames[0]].ncos[mode+res].field.vals, axis=1)
#print(an.vars[fieldNames[0]].ncos[mode+res].field.vals.shape)
